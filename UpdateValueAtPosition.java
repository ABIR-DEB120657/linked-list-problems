...
//            }
        ...
        void MaximumValue(){
            ...
            //you can use this formula (count - n + 1)th
            void nthnodeatend(int positionY){
            if(head == null){
                System.out.println("empty linked list");
                return;
            }
            if(positionY < 1 || positionY > count){
                System.out.println("value not found");
                return;
            }
            Node1 temp1122 = head;
            for(int i = count;i>positionY;i--){
                temp1122 = temp1122.next;
            }
            System.out.println("nth node value is = "+temp1122.data);
            }

            void updatevalueatposition(int positionI, int valueR){
            if(head == null){
                System.out.println("empty linked list");
                return;
            }
            if(positionI < 1 || positionI > count){
                System.out.println("position out of linked list range");
                return;
            }
            Node1 temp11 = head;
            for(int i = 1; i< positionI; i++){
                temp11 = temp11.next;
            }
            temp11.data = valueR;
            }
...
public class createnode {
    public static void main(String[] args) {
        ...
        newnode.display();
        newnode.nthnode(4);
        newnode.nthnodeatend(4);
        newnode.nthnodeatend(3);
        newnode.nthnodeatend(2);
        newnode.nthnodeatend(1);
        newnode.nthnodeatend(0);
        System.out.print("display linked list = ");
        newnode.display();
        newnode.updatevalueatposition(1,100);
        newnode.display();
        newnode.updatevalueatposition(2,200);
        newnode.display();
        newnode.updatevalueatposition(3,300);
        newnode.display();
        newnode.updatevalueatposition(4,400);
        newnode.display();
        newnode.updatevalueatposition(5,500);
    }
}
